...
export type AnnouncementCategory = "system" | "maintenance" | "feature" | "announcement";

export type AnnouncementPriority = "low" | "medium" | "high" | "urgent";

export type AnnouncementTargetRole = "all" | "admin" | "operator" | "readonly";
...
export type Announcement = {
	...
	is_active: boolean;
	is_pinned: boolean;
	expiry_at: LocalDateTimeString | null;
	created_by: string;
	created_at: LocalDateTimeString;
	updated_at: LocalDateTimeString;
};
